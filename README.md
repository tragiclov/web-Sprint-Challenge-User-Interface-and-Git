...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    It's all about accesibility. To help someone that may have a hard time viewing websites

2. Name two big differences between ```display: block;``` and ```display: inline;```.
    inline allows a width and height on an element. Block respects the top and bottom margins
...
5. Explain why git is valuable to a team of developers.
    For multiple people to be able to code/edit each others code together. 
